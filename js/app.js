 ...
 */
    ...
    const Header = props => {
        ...
        }, "React sneakers"), react.createElement("p", null, "Магазин лучших кроссовок")))), react.createElement("div", {
    ...
    const Info = ({image, title, description}) => {
        const {setCartOpened} = react.useContext(context);
        return react.createElement("div", {
            className: "drawer__empty empty-drawer"
        }, react.createElement("div", {
            className: "empty-drawer__image"
        }, react.createElement("img", {
            src: image,
            alt: "Image"
        })), react.createElement("h3", {
            className: "empty-drawer__title"
        }, title), react.createElement("div", {
            className: "empty-drawer__text"
    ...
    const Drawer = ({onClickClose, items, onRemove = [], opened}) => {
        ...
        const onClickOrder = async () => {
            try {
                setIsLoading(true);
                const {data} = await lib_axios.post("https://67a24121409de5ed5254d2d5.mockapi.io/orders", {
                    items: cartItems
                });
                setOrderId(data.id);
                ...
                for (let index = 0; index < cartItems.length; index++) {
                    ...
                    await lib_axios.delete(`https://679e4c64946b0e23c06312ce.mockapi.io/cart/${item.id}`);
                    await delay(1e3);
                }
            } catch (error) {
        ...
        return react.createElement("div", {
        ...
        }, items.map((obj => react.createElement("div", {
            key: obj.id,
            ...
            className: "count-drawer__item"
        }, react.createElement("div", {
            className: "count-drawer__text"
        }, "Итого"), react.createElement("div", {
            className: "count-drawer__dash"
        }), react.createElement("div", {
            className: "count-drawer__summ"
        }, totalPrice, " руб.")), react.createElement("li", {
            className: "count-drawer__item"
        }, react.createElement("div", {
            className: "count-drawer__text"
        }, "Налог 5%"), react.createElement("div", {
            className: "count-drawer__dash"
        }), react.createElement("div", {
            className: "count-drawer__summ"
        }, totalPrice / 100 * 5, " руб."))), react.createElement("button", {
            disabled: isLoading,
            onClick: onClickOrder,
            className: "drawer__button button-green"
        }, react.createElement("div", {
            className: "button-green__text"
...
***************************************************************************** */
    ...
    const Card = ({id, onFavourite, image, title, price, onPlus, favorited = false, loading = false}) => {
        ...
        return react.createElement("div", {
            className: "card"
        }, loading ? react.createElement(react_content_loader_es, {
            speed: 2,
            width: 142,
            height: 145,
            viewBox: "0 0 150 260",
            ...
            width: "85",
            height: "34"
        })) : react.createElement(react.Fragment, null, onFavourite && react.createElement("div", {
            ...
            className: "card__amout"
        }, price, " руб.")), react.createElement("button", {
    ...
    const Favourites = () => {
        const {favourites, onAddToFavourite} = react.useContext(context);
        return react.createElement("div", {
            className: "content"
        }, react.createElement("div", {
            className: "content__container"
        }, react.createElement("div", {
            className: "content__navbar"
        }, react.createElement("h1", {
            className: "content__title"
        }, "Мои закладки")), react.createElement("div", {
            className: "content__cards"
        }, favourites.map(((item, index) => react.createElement(components_Card, _extends({
            key: index,
            favorited: true,
            onFavourite: onAddToFavourite
        }, item)))))));
    };
    const components_Favourites = Favourites;
    ...
    const Orders = () => {
        const {onAddToCart, onAddToFavourite} = react.useContext(context);
        const [orders, setOrders] = react.useState([]);
        const [isLoading, setIsLoading] = react.useState(true);
        react.useEffect((() => {
            (async () => {
                try {
                    const {data} = await lib_axios.get("https://67a24121409de5ed5254d2d5.mockapi.io/orders");
        ...
        return react.createElement("div", {
            ...
            className: "content__title"
        }, "Мои покупки")), react.createElement("div", {
            className: "content__cards"
        }, (isLoading ? [ ...Array(10) ] : orders).map(((item, index) => react.createElement(components_Card, Orders_extends({
            key: index,
            loading: isLoading
        }, item)))))));
    };
    const components_Orders = Orders;
    ...
    const Home = ({items, searchValue, setSearchValue, onChangeSearchInput, onAddToFavourite, onAddToCart, isLoading}) => {
        const renderItems = () => (isLoading ? [ ...Array(10) ] : items).map(((item, index) => react.createElement(components_Card, Home_extends({
            key: index,
        ...
        return react.createElement("div", {
            ...
            className: "content__title"
        }, searchValue ? `Поиск по запросу:"${searchValue}"` : `Все кроссовки`), react.createElement("div", {
            className: "content__search search-block"
        }, react.createElement("div", {
            ...
            type: "text",
            placeholder: "Поиск...",
            className: "search-block__placeholder"
    ...
    function App() {
        ...
        react.useEffect((() => {
            async function fetchData() {
                try {
                    const [cartResponse, favouritesResponse, itemsResponse] = await Promise.all([ lib_axios.get("https://679e4c64946b0e23c06312ce.mockapi.io/cart"), lib_axios.get("https://67a24121409de5ed5254d2d5.mockapi.io/favourites"), lib_axios.get("https://679e4c64946b0e23c06312ce.mockapi.io/items") ]);
                    setIsLoading(false);
        ...
        const onAddToCart = async obj => {
            try {
                ...
                if (findItem) {
                    ...
                    await lib_axios.delete(`https://679e4c64946b0e23c06312ce.mockapi.io/cart/${findItem.id}`);
                } else {
                    const {data} = await lib_axios.post("https://679e4c64946b0e23c06312ce.mockapi.io/cart", obj);
        ...
        const onRemoveItem = id => {
            try {
                lib_axios.delete(`https://679e4c64946b0e23c06312ce.mockapi.io/cart/${id}`);
        ...
        const onAddToFavourite = async obj => {
            try {
                if (favourites.find((favObj => Number(favObj.id) === Number(obj.id)))) {
                    await lib_axios.delete(`https://679e4c64946b0e23c06312ce.mockapi.io/favourites/${obj.id}`);
                    setFavourites((prev => prev.filter((item => Number(item.id) !== Number(obj.id)))));
                } else {
                    const {data} = await lib_axios.post("https://67a24121409de5ed5254d2d5.mockapi.io/favourites", obj);
        ...
        }, react.createElement(components_Drawer, {
